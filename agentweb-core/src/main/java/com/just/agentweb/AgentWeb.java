...
public final class AgentWeb {
    ...
    public static class PreAgentWeb {
        ...
        public AgentWeb loadUrl(@Nullable String url) {
            if (!isReady) {
                ready();
            }
            return mAgentWeb.loadUrl(url);
        }

        public AgentWeb loadUrl(@Nullable String url, Map<String, String> additionalHttpHeaders) {
            if (!isReady) {
                ready();
            }
            return mAgentWeb.loadUrl(url, additionalHttpHeaders);
        }


        public AgentWeb loadDataWithBaseURL(String baseUrl, String data, String mimeType, String encoding, String historyUrl) {
            if (!isReady) {
                ready();
            }
            return mAgentWeb.loadDataWithBaseURL(baseUrl, data, mimeType, encoding, historyUrl);
        }
    ...
    // TODO: 2018/6/10 wizos
    private AgentWeb loadUrl(String url, Map<String, String> additionalHttpHeaders) {
        this.getUrlLoader().loadUrl(url, additionalHttpHeaders);
        IndicatorController mIndicatorController = null;
        if (!TextUtils.isEmpty(url) && (mIndicatorController = getIndicatorController()) != null && mIndicatorController.offerIndicator() != null) {
            getIndicatorController().offerIndicator().show();
        }
    ...
    // TODO: 2018/4/1 wizos:
    private AgentWeb loadDataWithBaseURL(String baseUrl, String data, String mimeType, String encoding, String historyUrl) {
        this.getUrlLoader().loadDataWithBaseURL(baseUrl, data, mimeType, encoding, historyUrl);
        IndicatorController mIndicatorController = null;
        if (!TextUtils.isEmpty(data) && (mIndicatorController = getIndicatorController()) != null && mIndicatorController.offerIndicator() != null) {
            getIndicatorController().offerIndicator().show();
        }
        return this;
    }
