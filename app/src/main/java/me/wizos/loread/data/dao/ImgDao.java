...
public class ImgDao extends AbstractDao<Img, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Img entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Img entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final Long updateKeyAfterInsert(Img entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    @Override
    public boolean hasKey(Img entity) {
