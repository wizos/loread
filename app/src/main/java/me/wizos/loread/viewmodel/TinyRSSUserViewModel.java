...
public class TinyRSSUserViewModel extends LoginViewModel {
    ...
    public void login(String baseUrl, String username, String password) {
        TinyRSSApi tinyRSSApi = new TinyRSSApi(baseUrl);
        tinyRSSApi.login(username, password, new CallbackX<String,String>() {
            ...
            public void onSuccess(String auth) {
                ...
                user.setId(Contract.PROVIDER_TINYRSS + "_" + (baseUrl + "_" + username).hashCode());
