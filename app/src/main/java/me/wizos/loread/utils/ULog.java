 ...
 * http://blog.csdn.net/taki_dsm/article/details/7804922
 *
 */
public class ULog extends Service {
    ...
    @SuppressWarnings("unused") // 取消警告表示，在编译.java文件的时候，不在出现一些警告 ，如变量没有用到，会有提示警告，用 @SuppressWarnings("unused")之后 ，警告消失。
