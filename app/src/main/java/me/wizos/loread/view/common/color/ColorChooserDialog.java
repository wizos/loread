package me.wizos.loread.view.common.color;
...
//                .neutralText(builder.mAllowUserCustom ? builder.mCustomBtn : 0) // TEST:  去掉切换自定义与预设的按钮
...
//    }
    ...
    private class ColorGridAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            child.setTag(String.format(Locale.CANADA,"%d:%d", position, color));
