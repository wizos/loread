...
//        viewPager.setLayerType(View.LAYER_TYPE_HARDWARE,null);//开启硬件加速
        viewPager.clearOnPageChangeListeners();
...
//            KLog.e("加载完成：" + webView.getTitle() + " = " + url + " = " + webView.getId() + "  耗时：" + (System.currentTimeMillis() - timeMap.get(webView)) );
        ...
        OkGo.get(selectedArticle.getCanonical()).client(articleHttpClient).getRawCall().enqueue(new okhttp3.Callback() {
            ...
            public void onResponse(Call call, okhttp3.Response response) throws IOException {
                if (response.isSuccessful()) {
                    ...
                    if (BuildConfig.DEBUG) {
                        SnackbarUtil.Long(selectedWebView, "保存 Readability 内容？")
