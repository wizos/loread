...
public class ArticleViewModel extends ViewModel {
    ...
    public LiveData<PagedList<Article>> getAllByKeyword(String uid, String keyword){
        ...
        // setPageSize 指定每次分页加载的条目数量
        articles = new LivePagedListBuilder<>(CoreDB.i().articleDao().getAllByKeyword(uid,keyword,time), new PagedList.Config.Builder()
        ...
        articleIdsLiveData = CoreDB.i().articleDao().getAllIdsByKeyword(uid, keyword, time);
        return articles;
    }
}
